...
export default function About() {
    ...
    const webSkills = ['JavaScript', 'Python', 'React', 'HTML 5', 'CSS 3', 'Node', 'Express', 'MongoDB', 'WebGL', 'Three.js', 'D3.js', 'Git'];
    const roboticsSkills = ['ROS', 'Gazebo', 'LabVIEW', "PLC's", "MCU's", 'Arduino', 'Raspberry Pi','AutoCAD', 'SolidWorks', 'Mechanical Design', '3d Printing', 'Electrical Schematics'];    
    ...
    return (
        <div className={classes.root}>
            <div className={`${classes.gridItem} ${classes.about}`}>
                ...
                <Divider variant="middle" />
                  <div className={classes.content}>
                    ...
                    <Typography paragraph variant='body1' className={classes.lastParagraph}>
            ...
            <AboutSkills skills={webSkills} title={'Web Skills'} classes={classes} classType={'webSkills'} isMobile={isMobile} />
            <AboutSkills skills={roboticsSkills} title={'Robotics Skills'} classes={classes} classType={'roboticsSkills'} isMobile={isMobile} />            
        </div>
    )
}
